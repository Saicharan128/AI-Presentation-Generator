...
def generate_yaml_from_topic(topic, include_images=True):
    ...
    chat_messages = [
        {"role": "system", "content": "You generate YAML content for informative presentations. Never output questions, only clear explanations. Generate exactly the number of slides requested."},
    ...
    try:
        ...
        if slide_count and len(slides) != slide_count:
            ...
            chat_messages[1]["content"] = adjusted_prompt
